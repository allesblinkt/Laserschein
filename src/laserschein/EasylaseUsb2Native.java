...
public class EasylaseUsb2Native {
	 ...
	 */
	public static native boolean EasyLaseWriteFrame(IntByReference CardNumber, PTSTRUCT.ByReference Datapointer, int Bytenumber, short Pointspeed);
	// Must be tested with laser! 
	 ...
	 * @return true -> Okay, false -> USB error
	 */
	public static native boolean EasyLaseWriteFrameNR(IntByReference CardNumber, PTSTRUCT.ByReference Datapointer, int Bytenumber, short Pointspeed, short RepNum);
	// Must be tested with laser!
